...
class DevHub_Formatting {
	 ...
	 * - Double single quotes never means any sort of curly quotes.
	 *
	 * @param  string      $content   The post content.
	 * @param  null|string $post_type Optional. The post type. Default null.
	 * @return string
	...
	public static function fix_unintended_markdown( $content, $post_type = null ) {
		...
		// Double curly quote (converted from double single quotes) should be preserved as two
		// non-curly single quotes.
