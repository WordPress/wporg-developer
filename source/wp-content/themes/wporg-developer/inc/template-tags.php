...
namespace DevHub {
	...
	function get_description( $post = null ) {
		...
		$description = str_replace( '<pre><code>', '<!-- wp:code {"lineNumbers":true} --><pre class="wp-block-code"><code lang="php" class="language-php line-numbers">', $description );
		$description = str_replace( '</code></pre>', '</code></pre><!-- /wp:code -->', $description );
