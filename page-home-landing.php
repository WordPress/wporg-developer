		...
		<div class="home-landing">
			...
			<div class="inner-wrap section">
				...
				<div class="box box-code-ref">
					<h3><a href="<?php echo esc_url( home_url( '/reference' ) ); ?>" class="widget-title"><div class="dashicons dashicons-editor-code"></div><?php _e( 'Code Reference', 'wporg' ); ?></a></h3>
				...
				<div class="box box-coding-standards">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'wpcs-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-code-standards"></div><?php _e( 'Coding Standards', 'wporg' ); ?></a></h3>
				...
				<div class="box box-block-editor">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'blocks-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-edit"></div><?php _e( 'Block Editor', 'wporg' ); ?></a></h3>
				...
				<div class="box box-apis">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'apis-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-admin-site-alt3"></div><?php _e( 'Common APIs', 'wporg' ); ?></a></h3>
				...
				<div class="box box-themes">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'theme-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-admin-appearance"></div><?php _e( 'Themes', 'wporg' ); ?></a></h3>
				...
				<div class="box box-plugins">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'plugin-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-admin-plugins"></div><?php _e( 'Plugins', 'wporg' ); ?></a></h3>
				...
				<div class="box box-rest-api">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'rest-api-handbook' ) ); ?>" class="widget-title"><div class="dashicons dashicons-rest-api"></div><?php _e( 'REST API', 'wporg' ); ?></a></h3>
				...
				<div class="box box-wp-cli">
					<h3><a href="<?php echo esc_url( get_post_type_archive_link( 'command' ) ); ?>" class="widget-title"><div class="dashicons dashicons-arrow-right-alt2"></div><?php _e( 'WP-CLI', 'wporg' ); ?></a></h3>
